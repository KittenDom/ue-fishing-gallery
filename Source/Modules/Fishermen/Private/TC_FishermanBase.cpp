...
void ATC_FishermanBase::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATC_FishermanBase::Move);

		// Looking
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATC_FishermanBase::Look);
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATC_FishermanBase::Look);
	}
	else
	{
...
void ATC_FishermanBase::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATC_FishermanBase::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
